...
function compileContent() {
    ...
    var b = {
        ...
        work: {
            position: ["Developer", "Project Architect"],
            company: '<a href="http://opencore.cl">Opencore</a>',
            location: "Santiago, Chile"
        },
        interests: {
            type: "Coding and Piano",
            portfolio: ['<a href="http://rosgh.elbraulio.com">http://rosgh.elbraulio.com</a>', 
                '<a href="http://neuralnet.elbraulio.com">http://neuralnet.elbraulio.com</a>',
                '<a href="http://genetical.elbraulio.com">http://genetical.elbraulio.com</a>',
                '<a href="http://survey.elbraulio.com">http://survey.elbraulio.com/</a>'
            ]
        },
        social: ['<a class="item" href="https://github.com/elbraulio">github.com/elbraulio</a>', '<a class="item" href="https://stackoverflow.com/users/10625458/elbraulio">StackOverflow</a>'],
        contact: '<a class="item" href="mailto:' + a + '">' + a + "</a>"
    };
